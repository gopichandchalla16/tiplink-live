          ...
          <div
            ...
            style={
              step > s
                ...
                : step === s
                ? { width: 20, height: 8, background: '#9945FF' }
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 1 && (
            ...
            >
              ...
              <p className="text-gray-400 text-center text-sm mb-8">
                Link Phantom to create your creator profile. Non-custodial — we never touch your keys.
              </p>
              <div className="flex justify-center gap-6 mb-8">
                {[
                  { icon: Shield, label: 'Non-custodial' },
                  { icon: CheckCircle, label: 'Read-only' },
              ...
              <button onClick={connectWallet} disabled={connecting} className="btn-primary w-full">
                {connecting ? (
                  ...
                  <><Shield className="w-4 h-4" /> Connect Phantom Wallet</>
                )}
              </button>
            </motion.div>
          )}
            ...
            >
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  ...
                  <div className="absolute right-3 top-1/2 -translate-y-1/2">
                    ...
                    {usernameStatus === 'taken' && (
                      <span className="text-xs text-red-400 font-bold">Taken</span>
                    )}
                  </div>
                </div>
                {usernameStatus === 'available' && (
                  <p className="text-green-400 text-xs mt-1">
                    ✓ tiplink-live.vercel.app/tip/{username}
                  </p>
                )}
              </div>
              ...
              <div className="mb-4">
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <button
                    onClick={enhanceBio}
                    disabled={!bio || !displayName || enhancing}
          ...
          {step === 3 && (
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-6">
                Gemini AI writes your thank-you messages in this style.
              </p>
              ...
              >
                ...
                <p className="text-gray-300 text-sm italic">
                  {PERSONALITIES.find((p) => p.key === personality)?.sample}
                </p>
              </div>
          ...
          {step === 4 && (
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-6">
                Your TipLink is ready to receive tips on Solana.
              </p>
